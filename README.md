...
```sh
pip install git+https://github.com/juliecoust/ecotaxa-cli-py.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/juliecoust/ecotaxa-cli-py.git`)
