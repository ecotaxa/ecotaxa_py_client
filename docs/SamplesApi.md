...
> list[SampleTaxoStatsModel] sample_set_get_stats_sample_set_taxo_stats_get(sample_ids=sample_ids)
...
> list[SampleModel] samples_search_samples_search_get(project_ids=project_ids, id_pattern=id_pattern)
