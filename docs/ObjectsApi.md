...
> object classify_auto_object_set(classify_auto_req)
...
# **classify_object_set**
> object classify_object_set(classify_req)
...
with ecotaxa_cli_py.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ecotaxa_cli_py.ObjectsApi(api_client)
    body_export_object_set = ecotaxa_cli_py.BodyExportObjectSetObjectSetExportPost() # BodyExportObjectSetObjectSetExportPost | 
...
> object reclassify_object_set(project_id, forced_id, reason, project_filters)
...
# **update_object_set**
> object update_object_set(bulk_update_req)
