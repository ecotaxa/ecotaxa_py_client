...
# **project_merge**
> MergeRsp project_merge(project_id, source_project_id=source_project_id, dry_run=dry_run)
...
> list[ProjectTaxoStatsModel] project_set_get_stats(ids=ids, taxa_ids=taxa_ids)
...
> list[ProjectUserStatsModel] project_set_get_user_stats(ids=ids)
...
# **project_stats**
> object project_stats(project_id)
