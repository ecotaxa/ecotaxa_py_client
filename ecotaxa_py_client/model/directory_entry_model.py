...
class DirectoryEntryModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, size, mtime, *args, **kwargs):  # noqa: E501
        """DirectoryEntryModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, size, mtime, *args, **kwargs):  # noqa: E501
        """DirectoryEntryModel - a model defined in OpenAPI
