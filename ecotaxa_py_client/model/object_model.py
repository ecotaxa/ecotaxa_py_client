...
class ObjectModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, objid, acquisid, orig_id, sample_id, project_id, random_value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            classif_crossvalidation_id (int): Always NULL, kept for compat.. [optional]  # noqa: E501
            similarity (float): Always NULL, kept for compat.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, objid, acquisid, orig_id, sample_id, project_id, random_value, *args, **kwargs):  # noqa: E501
        """ObjectModel - a model defined in OpenAPI
