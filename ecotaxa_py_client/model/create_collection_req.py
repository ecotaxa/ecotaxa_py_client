...
class CreateCollectionReq(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, project_ids, *args, **kwargs):  # noqa: E501
        """CreateCollectionReq - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, project_ids, *args, **kwargs):  # noqa: E501
        """CreateCollectionReq - a model defined in OpenAPI
