...
class AcquisitionModel(ModelNormal):
    ...
    attribute_map = {
        ...
        'acq_sample_id': 'acq_sample_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, acquisid, acq_sample_id, orig_id, *args, **kwargs):  # noqa: E501
        """AcquisitionModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            instrument (str): Instrument used.. [optional]  # noqa: E501
            free_columns ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Free columns from acquisition mapping in project.. [optional] if omitted the server will use the default value of {}  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, acquisid, acq_sample_id, orig_id, *args, **kwargs):  # noqa: E501
        """AcquisitionModel - a model defined in OpenAPI
