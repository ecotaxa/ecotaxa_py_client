...
class ProjectModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bodc_variables': ({str: (str,)},),  # noqa: E501
            'init_classif_list': ([int],),  # noqa: E501
            'managers': ([MinUserModel],),  # noqa: E501
            'annotators': ([MinUserModel],),  # noqa: E501
            'viewers': ([MinUserModel],),  # noqa: E501
            'instrument': (str,),  # noqa: E501
            'instrument_url': (str,),  # noqa: E501
            'contact': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'bodc_variables': 'bodc_variables',  # noqa: E501
        ...
        'instrument_url': 'instrument_url',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, projid, title, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            bodc_variables ({str: (str,)}): BODC quantities from columns. Only the 3 keys listed in example are valid.. [optional] if omitted the server will use the default value of {}  # noqa: E501
            ...
            managers ([MinUserModel]): Managers of this project.. [optional] if omitted the server will use the default value of []  # noqa: E501
            annotators ([MinUserModel]): Annotators of this project, if not manager.. [optional] if omitted the server will use the default value of []  # noqa: E501
            viewers ([MinUserModel]): Viewers of this project, if not manager nor annotator.. [optional] if omitted the server will use the default value of []  # noqa: E501
            instrument (str): This project's instrument code.. [optional]  # noqa: E501
            instrument_url (str): This project's instrument BODC definition.. [optional]  # noqa: E501
            contact (bool, date, datetime, dict, float, int, list, str, none_type): The contact person is a manager who serves as the contact person for other users and EcoTaxa's managers.. [optional]  # noqa: E501
            ...
            license (bool, date, datetime, dict, float, int, list, str, none_type): Data licence.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, projid, title, *args, **kwargs):  # noqa: E501
        """ProjectModel - a model defined in OpenAPI
