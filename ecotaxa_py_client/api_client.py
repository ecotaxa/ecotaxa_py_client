...
from ecotaxa_py_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ecotaxa_py_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.21/python'
