...
class UsersApi:
    ...
    def get_users(
        ...
        summary: Annotated[Optional[StrictBool], Field(description="Return users except rights and last_used_projects if set to True. For users list display purpose.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type ids: str
        :param summary: Return users except rights and last_used_projects if set to True. For users list display purpose.
        :type summary: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
