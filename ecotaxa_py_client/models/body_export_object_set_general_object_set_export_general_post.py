...
class BodyExportObjectSetGeneralObjectSetExportGeneralPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filters", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": ProjectFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "request": GeneralExportReq.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
