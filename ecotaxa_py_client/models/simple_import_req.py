...
class SimpleImportReq(BaseModel):
    ...
    """ # noqa: E501
    source_path: StrictStr = Field(description="Source path on server, to zip or plain directory.")
    values: Dict[str, StrictStr] = Field(description=":imgdate, imgtime, latitude, longitude, depthmin, depthmax, taxolb, userlb, status")
    possible_values: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["source_path", "values", "possible_values"]
