...
class TaxonomyTreeStatus(object):
    ...
    def __init__(self, last_refresh=None, local_vars_configuration=None):  # noqa: E501
        """TaxonomyTreeStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaxonomyTreeStatus):
            return False
