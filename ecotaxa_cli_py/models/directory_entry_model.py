...
class DirectoryEntryModel(object):
    ...
    def __init__(self, name=None, type=None, size=None, mtime=None, local_vars_configuration=None):  # noqa: E501
        """DirectoryEntryModel - a model defined in OpenAPI"""  # noqa: E501
    ...
    def mtime(self, mtime):
        ...
        :type mtime: str
        """
        if self.local_vars_configuration.client_side_validation and mtime is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryEntryModel):
            return False
