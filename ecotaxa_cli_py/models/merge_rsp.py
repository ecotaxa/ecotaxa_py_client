...
class MergeRsp(object):
    ...
    def __init__(self, errors=[], local_vars_configuration=None):  # noqa: E501
        """MergeRsp - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MergeRsp):
            return False
