...
class Constants(object):
    ...
    def license_texts(self, license_texts):
        ...
        :type license_texts: dict(str, str)
        """
    ...
    def app_manager(self, app_manager):
        ...
        :type app_manager: list[str]
        """
        if (self.local_vars_configuration.client_side_validation and
                app_manager is not None and len(app_manager) > 2):
            raise ValueError("Invalid value for `app_manager`, number of items must be less than or equal to `2`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                app_manager is not None and len(app_manager) < 2):
            raise ValueError("Invalid value for `app_manager`, number of items must be greater than or equal to `2`")  # noqa: E501
