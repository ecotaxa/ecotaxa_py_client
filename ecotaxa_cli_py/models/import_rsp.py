...
class ImportRsp(object):
    ...
    def __init__(self, job_id=None, errors=[], local_vars_configuration=None):  # noqa: E501
        """ImportRsp - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportRsp):
            return False
