...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.project_set_get_column_stats_project_set_column_stats_get_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'project_set_get_column_stats_project_set_column_stats_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.set_project_predict_settings_projects_project_id_prediction_settings_put_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'BearerOrCookieAuth'
                ...
                'operation_id': 'set_project_predict_settings_projects_project_id_prediction_settings_put',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def project_set_get_column_stats_project_set_column_stats_get(
        self,
        ids,
        names,
        **kwargs
        ...
        **Returns projects validated data statistics**, for all named columns, in all given projects.  The free columns here are named by the alias e.g. 'area', not technical name e.g. 'n43'.  This allows getting stats on projects with different mappings, but common names.  # noqa: E501
        ...
        kwargs['names'] = \
            names
        return self.project_set_get_column_stats_project_set_column_stats_get_endpoint.call_with_http_info(**kwargs)
    ...
    def set_project_predict_settings_projects_project_id_prediction_settings_put(
        self,
        project_id,
        settings,
        **kwargs
        ...
        **Update the project's prediction settings**, return **NULL upon success.**  🔒 Unlike during full project update above, which needs high permissions, this entry point is accessible to **project annotators**, as it mirrors the prediction privileges.  # noqa: E501
        ...
        kwargs['settings'] = \
            settings
        return self.set_project_predict_settings_projects_project_id_prediction_settings_put_endpoint.call_with_http_info(**kwargs)
