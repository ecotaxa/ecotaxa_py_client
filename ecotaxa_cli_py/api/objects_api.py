...
class ObjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.compute_project_cnn_project_do_cnn_get_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'BearerOrCookieAuth'
                ],
                'endpoint_path': '/project/do_cnn',
                'operation_id': 'compute_project_cnn_project_do_cnn_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.predict_object_set_object_set_predict_post_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'predict_object_set_object_set_predict_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def compute_project_cnn_project_do_cnn_get(
        self,
        proj_id,
        **kwargs
    ):
        ...
        **Generate CNN features** for the requested project.  **Returns a string containing the number of generated features.**  # noqa: E501
        ...
        kwargs['proj_id'] = \
            proj_id
        return self.compute_project_cnn_project_do_cnn_get_endpoint.call_with_http_info(**kwargs)
    ...
    def predict_object_set_object_set_predict_post(
        self,
        body_predict_object_set_object_set_predict_post,
        **kwargs
    ):
        ...
        **Start a prediction** AKA automatic classification for the given object set and options.  # noqa: E501
        ...
        kwargs['body_predict_object_set_object_set_predict_post'] = \
            body_predict_object_set_object_set_predict_post
        return self.predict_object_set_object_set_predict_post_endpoint.call_with_http_info(**kwargs)
