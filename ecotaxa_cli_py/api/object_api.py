...
class ObjectApi(object):
    ...
    def object_query_history_object_object_id_history_get(self, object_id, **kwargs):  # noqa: E501
        ...
        return self.object_query_history_object_object_id_history_get_with_http_info(object_id, **kwargs)  # noqa: E501
    ...
    def object_query_history_object_object_id_history_get_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method object_query_history_object_object_id_history_get" % key
                )
        ...
        if self.api_client.client_side_validation and ('object_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `object_id` when calling `object_query_history_object_object_id_history_get`")  # noqa: E501
    ...
    def object_query_object_object_id_get(self, object_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.object_query_object_object_id_get_with_http_info(object_id, **kwargs)  # noqa: E501
    ...
    def object_query_object_object_id_get_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method object_query_object_object_id_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'object_id' is set
        if self.api_client.client_side_validation and ('object_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['object_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `object_id` when calling `object_query_object_object_id_get`")  # noqa: E501
