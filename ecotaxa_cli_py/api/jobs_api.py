...
class JobsApi(object):
    ...
    def reply_job_question(self, job_id, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.reply_job_question_with_http_info(job_id, body, **kwargs)  # noqa: E501

    def reply_job_question_with_http_info(self, job_id, body, **kwargs):  # noqa: E501
        """Reply Job Question  # noqa: E501
        ...
        >>> thread = api.reply_job_question_with_http_info(job_id, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `body` when calling `reply_job_question`")  # noqa: E501
