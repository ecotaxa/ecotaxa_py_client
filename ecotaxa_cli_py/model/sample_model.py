...
class SampleModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sampleid, orig_id, *args, **kwargs):  # noqa: E501
        """SampleModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            projid (int): The project Id. [optional]  # noqa: E501
            latitude (float): The latitude. [optional]  # noqa: E501
            longitude (float): The longitude. [optional]  # noqa: E501
            dataportal_descriptor (str): [optional]  # noqa: E501
            free_columns ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Free columns from sample mapping in project. [optional] if omitted the server will use the default value of {}  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, sampleid, orig_id, *args, **kwargs):  # noqa: E501
        """SampleModel - a model defined in OpenAPI
