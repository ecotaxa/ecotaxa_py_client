...
class ImportRsp(ModelNormal):
    ...
    def _from_openapi_data(cls, job_id, *args, **kwargs):  # noqa: E501
        """ImportRsp - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            errors ([str]): Errors from analysis.. [optional] if omitted the server will use the default value of []  # noqa: E501
        """
