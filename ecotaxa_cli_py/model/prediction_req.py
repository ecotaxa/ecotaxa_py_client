...
class PredictionReq(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project_id, source_project_ids, features, categories, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, project_id, source_project_ids, features, categories, *args, **kwargs):  # noqa: E501
        """PredictionReq - a model defined in OpenAPI
